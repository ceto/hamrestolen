...
add_action( 'init', 'hs_create_apartment' ); 
/********* END OF Custom Post Types for Apartment Management ****************/


/************* Custom Building Taxonomies for Apartment Management *********/
add_action( 'init', 'hs_create_building_taxonomies', 0 );
function hs_create_building_taxonomies() {
...
/************ MetaBoxes **********/
add_filter( 'cmb2_meta_boxes', 'hs_metaboxes' );
function hs_metaboxes( array $meta_boxes ) {
    /**
     * Apartment Metaboxes
    */
  $prefix = '_meta_';
  ...
  $meta_boxes['page'] = array(
    ...
    'fields'     => array(
      array(
        'id'          => 'sections',
        'type'        => 'group',
        'description'        => __( 'Page Sections', 'cmb' ),
        'options'     => array(
...
add_action('admin_init','hs_remove_editor');
function hs_remove_editor() {
